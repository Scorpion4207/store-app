export const BurgerMenu = () => (
  <div className="position: fixed -top-full right-0 left-0 z-50 flex h-50 items-center justify-center rounded-b-4xl border-2 border-black bg-white sm:hidden">
    <div>
      <nav>
        <ul className="flex flex-col gap-4 text-2xl dark:text-black">
          <li className="flex">
            <a href="#" className="flex items-center gap-2">
              <svg
                className="h-[40px] w-[40px] text-gray-900"
                aria-hidden="true"
